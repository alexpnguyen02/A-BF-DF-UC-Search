...
public class SearchNode
{
    ...
    private include.State curState;
     ...
     */
    public SearchNode(include.State s)
    {
        curState = s;
        parent = null;
        cost = 0;
     ...
     */
    public SearchNode(SearchNode prev, include.State s, double c, double h)
    {
        parent = prev;
        curState = s;
        cost = c;
     ...
     * @return the curState
     */
    public include.State getCurState()
    {
        return curState;
    }
